# Standard 2D U-Net Implementation 
...
class UNet(nn.Module):
    def __init__(self, in_channels=1, num_classes=9, base=64, bilinear=True):
        super().__init__()
...
def build_model(cfg):
    # Factory: returns the model selected in config. For now: UNet baseline
